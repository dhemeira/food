...
const variantClass: Record<ButtonVariant, string> = {
  ...
  danger:
    ...
    'pointer-fine:hover:bg-ui-danger pointer-fine:hover:text-white pointer-fine:hover:shadow-[0_0_25px_-10px_var(--color-ui-danger)]',
  'danger-full':
    'border-ui-danger bg-ui-danger text-white ' +
    'active:shadow-[0_0_25px_-5px_var(--color-ui-danger)] ' +
